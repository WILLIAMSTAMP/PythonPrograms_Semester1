...
print()
print("Number Of Pass Attempts:  {:>3}   Pass Completion %:  {:>4,.0f}% ".format(Num_Pass_Att, Pass_Comp_Perc))
print("Number of Completitions:  ", Num_Pass_Comp)
print("Total Passing Yards:      {:>3}   Yards Per Pass:  {:>8,.2f}".format(Total_Pass_Yrds, Yards_per_Pass * 100))
print("Number of Touchdowns:      ", Num_Touchdowns)
print("Number of Intercepts:     {:>3}   Quarterback Rating: {:>2.1f}".format(Num_IntCP, QB_Rating))
print()
print("Number of rushing AAtts:   {:>2}   Avg Yards Per Rush:  {:>4.1f} ".format(Rush_Att, RBScore1))
print("Total Rushing Yards:   {:>6}   ".format(Total_Rush_Yards))
print("Number of Rushing TD,s:    {:>2}   TD Efficiency: {:>9.2f}%  ".format(Rush_Touchdowns, RBScore2))
print("-----------------------------------------------------------")
